...
\begin{frame}{Hard thresholding for spectral density}
\begin{equation}
...
\end{cases}
\end{equation}
As discussed before, $\lambda$ should be proportional to an upper bound $\sup_{\omega}\max_{rr}$, \cite{sun2018large} choose a loose bound $\mathcal{M}(f_X) = \sup_{\omega} \|f(\omega)\|$. 
\end{frame}


\begin{frame}{Technical Challenge}
