...
% the standard technique to find the best rank-$r$ approximation is the randomized Singular Value Decomposition (randomized SVD) \cite{halko2011finding}. Only its first step of finding an approximation to the range of $\mathbf{X}$ involves the sketching, so we will restrict our attention to this step. 
...
%such as Higher-Order Orthogonal Iteration \cite{de2000multilinear}, Fast CANDECOMP/PARAFAC decomposition \cite{wang2015fast}, our paper ? 
